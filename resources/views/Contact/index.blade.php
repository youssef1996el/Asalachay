...
<head>
    ...
    <!--title-->
    <title>
            Conatct Us : Grostore Online Store
    </title>
...
<img src="https://grostore.themetags.com/public/frontend/default/assets/img/shapes/leaf-gray.png?v=v4.4.0" alt="tomato"
    ...
    <div class="container">
        ...
        <h2 class="mb-2 text-center">Entrer en contact</h2>
        <nav>
                ...
                <div class="row g-4">
                    <div class="col-xl-5">
                        <div class="contact-left-box position-relative overflow-hidden z-1 bg-primary p-6 d-flex flex-column h-100"
                            data-background="https://grostore.themetags.com/public/frontend/default/assets/img/shapes/circle-half-fill.png?v=v4.4.0">
                            <img src="https://grostore.themetags.com/public/frontend/default/assets/img/shapes/texture-overlay.png?v=v4.4.0"
                                alt="texture" class="position-absolute w-100 h-100 start-0 top-0 z--1">
                            <h3 class="text-white mb-3">Contact Details</h3>
                            <p class="fs-sm text-white"><strong>Adresse de bureau:
                                </strong> {{$Infos->address}}
                            </p>
                            ...
                            <ul class="contact-list">
                                <li class="d-flex align-items-center gap-3 flex-wrap">
                                    ...
                                    <div class="info">
                                        <span class="fw-medium text-white fs-xs">Appel d'urgence</span>
                                        <h5 class="mb-0 mt-1 text-white"> {{$Infos->phone}}</h5>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center gap-3 flex-wrap mt-3">
                                    ...
                                    <div class="info">
                                        <span
                                            class="fw-medium text-white fs-xs">Communication générale</span>
                                        <p class="mb-0 mt-1 text-white fw-medium"> {{$Infos->email}}</p>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-6">
                                    <div class="label-input-field">
                                        ...
                                        <input type="text" name="phone" placeholder="Vous téléphonez"
                                            required>
                                    </div>
                                </div>
