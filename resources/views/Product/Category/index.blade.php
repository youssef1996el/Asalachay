...
<head>
    ...
    <!--title-->
    <title>
            Products : Grostore Online Store
    </title>
...
<img src="https://grostore.themetags.com/public/frontend/default/assets/img/shapes/leaf-gray.png?v=v4.4.0" alt="tomato"
    ...
    <div class="container">
        ...
        <h2 class="mb-2 text-center">Des produits</h2>
        <nav>
            <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item fw-bold" aria-current="page"><a
                        href="{{url('/')}}">Accueil</a></li>
                <li class="breadcrumb-item fw-bold" aria-current="page">Produits</li>
            </ol>
        </nav>
    </div>
            </div>
    ...
    <div class="sidebar-widget category-widget bg-white py-5 px-4 border-top mobile-menu-wrapper scrollbar h-400px">
        <div class="widget-title d-flex">
            <h6 class="mb-0 flex-shrink-0">Catégories</h6>
            <span class="hr-line w-100 position-relative d-block align-self-end ms-1"></span>
        </div>
        <ul class="widget-nav mt-4">
            @foreach ($categories as $item)
            <li>
                <a href="{{url('products/Category/'.$item->id)}}" class="d-flex justify-content-between align-items-center">{{$item->category_name}}<span
                    class="fw-bold fs-xs total-count">{{$item->product_count}}</span>
                </a>
            </li>
            @endforeach
    ...
    <div class="sidebar-widget price-filter-widget bg-white py-5 px-4 border-top">
        <div class="widget-title d-flex">
            <h6 class="mb-0 flex-shrink-0">Filtrer par prix</h6>
            <span class="hr-line w-100 position-relative d-block align-self-end ms-1"></span>
        </div>
        <div class="at-pricing-range mt-4">
            <form action="{{url('filterByPrice')}}" method="get">
                ...
                <div class="d-flex align-items-center mt-3">
                    <input type="number" min="0" oninput="validity.valid||(value='0');"
                        ...
                        data-value="{{ isset($_GET['min_price']) ? $_GET['min_price'] : 0 }}" data-min-range="0">
                    <span class="d-inline-block ms-2 me-2 fw-bold">-</span>

                    <input type="number" max="40000"
                        oninput="validity.valid||(value='40000');"
                        class="max_price price-range-field price-input price-input-max" name="max_price"
                        data-value="{{ isset($_GET['max_price']) ? $_GET['max_price'] : 40000 }}" data-max-range="40000">

                </div>
                <button type="submit"  class="btn btn-primary btn-sm mt-3 ">Filtre</button>
            </form>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-10">
                                    ...
                                    <div class="thumbnail position-relative text-center p-4">
                                        ...
                                        <div class="product-btns position-absolute d-flex gap-2 flex-column">
                                            ...
                                            <a href="#" class="rounded-btn IconDisplayModelDetail" value={{$item->id}}><i
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="mb-2 tt-category tt-line-clamp tt-clamp-1">
                                            <a href="{{url('products/Category/'.$item->id)}}"class="d-inline-block text-muted fs-xxs">{{$item->category}}</a>
                                        </div>


                                        <a href="#"
                                            class="card-title fw-semibold mb-2 tt-line-clamp tt-clamp-1">{{$item->name}}
                                        </a>
                            ...
                            <nav>
                                <nav>
                                    ...
                                    {{-- <ul class="pagination">
                                        ...
                                        <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/products?tag_id=3&amp;page=2">2</a></li>
                                        <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/products?tag_id=3&amp;page=3">3</a></li>
                                        <li class="page-item">
                                            <a class="page-link" href="https://grostore.themetags.com/products?tag_id=3&amp;page=2" rel="next" aria-label="Next &raquo;">&rsaquo;</a>
                                        </li>
                                    </ul> --}}
                                </nav>
                            </nav>
...
<script>
    ...
    function addToWishlist(productId) {
        ...
        function loadTemplate(){
            $.ajax({
                url: "https://grostore.themetags.com/filter-templates",
                type: "GET",
                dataType: "html",
                success: function(data){
