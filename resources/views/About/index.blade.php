...
<head>
    ...
    <meta name="csrf-token" content="nN8tuaI66nnavC0AM9EFJpQ4FcI2Z06DGyUuOirT">
    ...
    <!--title-->
    <title>
            About Us : Grostore Online Store
    </title>
...
<img src="https://grostore.themetags.com/public/frontend/default/assets/img/shapes/leaf-gray.png?v=v4.4.0" alt="tomato"
    ...
    <div class="container">
        ...
        <h2 class="mb-2 text-center">À propos de nous</h2>
        <nav>
            <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item fw-bold" aria-current="page"><a
                        href="{{url('/')}}">Accueil</a></li>

                <li class="breadcrumb-item fw-bold" aria-current="page">À propos</li>
            </ol>
        </nav>
    </div>
            </div>
       ...
       <div class="container">
        <div class="d-flex justify-content-center items-center">
           <div class="card shadow p-3 rounded-2" >
                <div class="card-body">
                    <h5 class="text-center mb-5">Bienvenue sur [Nom de votre site] !</h5>
                <p class="card-text">

                    Nous sommes une équipe passionnée qui croit en l'accessibilité et la commodité du shopping en ligne. Chez [Nom de votre site], nous nous efforçons de vous offrir une expérience de magasinage exceptionnelle, où vous pouvez trouver une large sélection de produits de qualité, le tout à portée de clic.

                    Notre mission est de simplifier votre vie en vous proposant une gamme diversifiée de produits, soigneusement sélectionnés pour répondre à vos besoins et à vos désirs. Que vous recherchiez des vêtements tendance, des articles pour la maison, des gadgets technologiques ou des cadeaux uniques, nous avons tout ce qu'il vous faut.

                    Ce qui nous distingue chez [Nom de votre site], c'est notre engagement envers la satisfaction du client. Nous nous efforçons continuellement d'améliorer nos services pour garantir que votre expérience de magasinage soit sans tracas et agréable. Notre équipe dévouée est toujours disponible pour répondre à vos questions, résoudre vos problèmes et vous offrir un soutien personnalisé à chaque étape de votre parcours d'achat.

                    En tant qu'entreprise, nous nous engageons également à être socialement responsables et à contribuer positivement à notre communauté. Nous soutenons des initiatives écologiques, des causes humanitaires et des organisations caritatives qui ont un impact positif sur le monde qui nous entoure.

                    Nous vous remercions de choisir [Nom de votre site] pour vos besoins d'achat en ligne. Nous sommes honorés de faire partie de votre vie et nous nous engageons à vous offrir une expérience de magasinage exceptionnelle à chaque fois que vous visitez notre site.

                    Merci de votre confiance et de votre soutien continu.

                    L'équipe de [Nom de votre site]</p>
            ...
            <div class="row g-5 g-xl-4 align-items-center">
                <div class="col-xl-6">
                    <div class="ab-left position-relative">
                        <img src="https://grostore.themetags.com/public/uploads/media/uHJUnKSPCnxPMqvB4SDKRScR3wzi2qnoMYf5LMOf.png" alt="" class="img-fluid">
                        <div class="text-end">
                            <div class="ab-quote p-4 text-start">
                                <h4 class="mb-0 fw-normal text-white">“Assertively target market Lorem ipsum is simply free consectetur notted elit sed do eiusmod” <span
                                        class="fs-md fw-medium position-relative">George Scholll</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-6">
                    <div class="ab-about-right">
                        ...
                        <h2 class="mb-4">Be healthy & <br> eat fresh organic food</h2>
                        <p class="mb-8">Nous sommes une équipe passionnée qui croit en l'accessibilité et la commodité du shopping en ligne.
                             Chez [Nom de votre site], nous nous efforçons de vous offrir une expérience de magasinage exceptionnelle, où vous pouvez trouver une large sélection de produits de qualité, le tout à portée de clic.

                            Notre mission est de simplifier votre vie en vous proposant une gamme diversifiée de produits, soigneusement sélectionnés pour répondre à vos besoins et à vos désirs. Que vous recherchiez des vêtements tendance,
                             des articles pour la maison, des gadgets technologiques ou des cadeaux uniques, nous avons tout ce qu'il vous faut.

                            Ce qui nous distingue chez [Nom de votre site],
                             c'est notre engagement envers la satisfaction du client. Nous nous efforçons continuellement d'améliorer nos services pour garantir que votre expérience de magasinage soit sans tracas et agréable.
                             Notre équipe dévouée est toujours disponible pour répondre à vos questions, résoudre vos problèmes et vous offrir un soutien personnalisé à chaque étape de votre parcours d'achat.</p>
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="image-box py-6 px-4 image-box-border">
                                    <div class="icon position-relative">
                                        <img src="https://grostore.themetags.com/public/frontend/default/assets/img/icons/hand-icon.svg?v=v4.4.0"
        ...
        <div class="container">
            <div class="brand-wrapper px-5 rounded-4">
                ...
                <div class="brands-slider swiper px-2 pt-4 pb-7">
                                ...
                                <img src="https://grostore.themetags.com/public/uploads/media/Msqfr2BOKyJczzH0LRsX5CjZmncpdCBDrIZraJ8G.png" alt=""
                                    class="img-fluid">
                            </div>
                                                    <div class="swiper-slide brand-item rounded">
                                <img src="https://grostore.themetags.com/public/uploads/media/PYwuWwj4EY2Ym5E4O9CVLI4WNs3TIH1nRswIa0Eg.png" alt=""
                                    class="img-fluid">
                            </div>
                                                    <div class="swiper-slide brand-item rounded">
                                <img src="https://grostore.themetags.com/public/uploads/media/1WGw2sD92Wf1Ex9asi9RELXlYoZMoDi22u1VCcFW.png" alt=""
                                    class="img-fluid">
                            </div>
                                                    <div class="swiper-slide brand-item rounded">
                                <img src="https://grostore.themetags.com/public/uploads/media/js3K8QAIBU9ecbMv54gIsABamUQtVVLYahwjAkFQ.png" alt=""
                                    class="img-fluid">
                            </div>
                                                    <div class="swiper-slide brand-item rounded">
                                <img src="https://grostore.themetags.com/public/uploads/media/d1TMFEm3rpUcqVPep1Q1hdv3yjxeTnMoCERiB0My.png" alt=""
                                    class="img-fluid">
                            </div>
                                            </div>
                </div>
    ...
    <section class="about-section bg-shade position-relative z-1 mt-5">
        ...
        {{-- <img src="https://grostore.themetags.com/public/frontend/default/assets/img/shapes/roll-color.png?v=v4.4.0" alt="roll"
            class="position-absolute roll-color z--1" data-parallax='{"y": -50}'>
        <img src="https://grostore.themetags.com/public/frontend/default/assets/img/shapes/roll-color-curve.png?v=v4.4.0" alt="roll"
            class="position-absolute roll-color-curve z--1" data-parallax='{"y": 50}'>
        <img src="https://grostore.themetags.com/public/frontend/default/assets/img/shapes/onion-color.png?v=v4.4.0" alt="onion"
            class="position-absolute onion-color z--1" data-parallax='{"x": -30}'> --}}
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section-title text-center">
                        <h2 class="mb-3">Notre capacité de travail</h2>
                        <p class="mb-0"></p>
                    </div>
                </div>
            </div>
            <div class="row g-4 mt-4">
                        ...
                        <div class="horizontal-counter d-flex align-items-center gap-3 bg-white rounded p-4">
                            <span
                                ...
                                <img src="https://grostore.themetags.com/public/uploads/media/T6LuS5A0YV4szuulJombsztIpvaMnHw22RrQFLna.png" alt="icon" class="img-fluid">
                            </span>
                            <div>
                                <h3 class="mb-1">100k+</h3>
                                <h6 class="mb-0 text-gray fs-sm">Produits totaux</h6>
                            </div>
                        </div>
                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="horizontal-counter d-flex align-items-center gap-3 bg-white rounded p-4">
                            <span
                                class="icon-wrapper d-inline-flex align-items-center justify-content-center rounded-2 flex-shrink-0">
                                <img src="https://grostore.themetags.com/public/uploads/media/4jgMskh4krixudE5vhWZAVZFUeM2UqHy6Txo2MWx.png" alt="icon" class="img-fluid">
                            </span>
                            <div>
                                <h3 class="mb-1">255k+</h3>
                                <h6 class="mb-0 text-gray fs-sm">Total des commandes</h6>
                            </div>
                        </div>
                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="horizontal-counter d-flex align-items-center gap-3 bg-white rounded p-4">
                            <span
                                class="icon-wrapper d-inline-flex align-items-center justify-content-center rounded-2 flex-shrink-0">
                                <img src="https://grostore.themetags.com/public/uploads/media/sLLS1fC37Ra1QxJEv8TmcJ0CNpACWsOEqSbXKknU.png" alt="icon" class="img-fluid">
                            </span>
                            <div>
                                <h3 class="mb-1">250k+</h3>
                                <h6 class="mb-0 text-gray fs-sm">Nombre total de visiteurs</h6>
                            </div>
                        </div>
                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="horizontal-counter d-flex align-items-center gap-3 bg-white rounded p-4">
                            <span
                                class="icon-wrapper d-inline-flex align-items-center justify-content-center rounded-2 flex-shrink-0">
                                <img src="https://grostore.themetags.com/public/uploads/media/4YYLabkQCb0lQYEu3RdLwhLedqLu0cjCaaiHP0Uy.png" alt="icon" class="img-fluid">
                            </span>
                            <div>
                                <h3 class="mb-1">1250+</h3>
                                <h6 class="mb-0 text-gray fs-sm">total des livreurs</h6>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-xl-5">
                    <div class="about-us-left position-relative">
                        <img src="https://grostore.themetags.com/public/uploads/media/0IDKVHfbMyMpiViurIP5ff83nbR5jLypT76YgbwZ.png" alt=""
                ...
                <div class="col-xl-7">
                    <div class="about-us-right">
                        <div class="section-title-mx mb-6">
                            ...
                            <h2 class="mb-3">We do not Buy from the <br> Open Market</h2>
                        ...
                        <div class="row g-3">
                                    ...
                                    <div
                                        ...
                                        <span class="icon-wrapper position-relative flex-shrink-0">
                                            <img src="https://grostore.themetags.com/public/uploads/media/uIUWZvcD1QLjDUUZksriYBKg9w2L2wyk45jQ0opx.svg" alt=""
                                                class="img-fluid">
                                        </span>
...
<script>
    ...
    function changeLocaleLanguage(e) {
        ...
        $.post("https://grostore.themetags.com/backend/change-language", {
            _token: 'nN8tuaI66nnavC0AM9EFJpQ4FcI2Z06DGyUuOirT',
            locale: locale
        }, function(data) {
            setTimeout(() => {
                location.reload();
    ...
    function getLogistics(city_id) {
        $.ajax({
            headers: {
                'X-CSRF-TOKEN': 'nN8tuaI66nnavC0AM9EFJpQ4FcI2Z06DGyUuOirT'
            },
